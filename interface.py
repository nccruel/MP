...
def incmb(): #COMBINING WORDS MODE 
	...
	def dcmb1():
		print("heart:", life)
		print("score:", score, "/", cmb.tot)
	dcmb()
	print("Loading...")
	from engine import cmb
	while life >= 0 and score <= cmb.tot:
		if score == cmb.tot:
			dcmb()
			dcmb1()
			print()
			print("Words for: " + '"' + cmb.scramble + '"' + ": ", end="")
			...
			dcmb1()
			print()
			print("Find the words that can be made with the letters of:", cmb.scramble)
